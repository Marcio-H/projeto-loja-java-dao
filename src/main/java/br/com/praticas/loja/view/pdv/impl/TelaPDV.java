package br.com.praticas.loja.view.pdv.impl;
...
public class TelaPDV extends javax.swing.JFrame {
    ...
    private JButton botaoBuscaCliente;
    private JButton botaoBuscaCondicaoPagamento;
    private JButton botaoBuscaProduto;
    private JButton botaoBuscaVendedor;
    private JButton botaoCancelaItem;
    private JButton botaoCancelarVenda;
    private JButton botaoFinalizarVenda;
    private JTextField codigoBarraProdutoTextField;
    private JTextField descricaoCondicaoPagamentoTextField;
    private JPanel form;
    private JPanel head;
    private JTextField idClienteTextField;
    private JTextField idCondicaoPagamentoTextField;
    ...
    private JTextField nomeVendedorTextField;
