...
import br.com.praticas.loja.view.cadastro.TelaCadastro;
import br.com.praticas.loja.view.cadastro.TelaCadastroCondicaoPagamento;

@Component("condicao_pagamento")
public class TelaCadastroCondicaoPagamentoImpl extends JFrame implements TelaCadastroCondicaoPagamento {

    public TelaCadastroCondicaoPagamentoImpl() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4 = new JLabel();
        numeroDiasAtePrimeiraParcela = new JTextField();
        jLabel5 = new JLabel();
        numeroDiasEntreParcelas = new JTextField();
        ...
        jLabel4.setText("Número de dias até primeira parcela");

        jLabel5.setText("Número de dias entre parcelas");
                        ...
                        .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(formLayout.createSequentialGroup()
                                .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(numeroDiasAtePrimeiraParcela, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabel5)
                                    .addComponent(numeroDiasEntreParcelas, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        formLayout.setVerticalGroup(
            ...
            .addGroup(formLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(numeroDiasAtePrimeiraParcela, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(numeroDiasEntreParcelas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private JTextField numeroDiasAtePrimeiraParcela;
    private JTextField numeroDiasEntreParcelas;
	...
	@Override
	public JTextField getNumeroDiasAtePrimeiraParcelaTextField() {
		return numeroDiasAtePrimeiraParcela;
	}

	@Override
	public JTextField getNumeroDiasEntreParcelasTextField() {
