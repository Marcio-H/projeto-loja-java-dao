...
public class TelaBuscaVendedor extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaBuscaVendedor
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaVendedor().setVisible(true);
            }
        });
    }
